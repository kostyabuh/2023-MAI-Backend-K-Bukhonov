...
class Worker(models.Model):
    ...
    wk_first_name = models.CharField(max_length=256, verbose_name='Имя работника', blank=False)
...
class Account(models.Model):
    ...
    acc_money = models.CharField(max_length=256, verbose_name='Количество денег', blank=False)
